...
public class SpiderFatEnemy : Enemy
{
    // Enemy class value overrides
    public override float speed => 1.7f;
    public override float strengthModifier => 1.2f;
    public override float runSpeedModifier => 1.8f;
    public override float visionDistance => 20.0f;
